...
BEGIN
  IF UPDATING THEN
    ...
    VALUES (USER, 'UPDATE', CURRENT_TIMESTAMP,
      ...
      'Despuï¿½s: {ID:' || :NEW.ID || ', NUMERO:' || :NEW.NUMERO || ', ESTADO:"' || :NEW.ESTADO || '"}');
  ELSIF DELETING THEN
    INSERT INTO RESTAURANTE.TBL_BITACORA (USUARIO, OPERACION, FECHA, DETALLE)
...
BEGIN
  IF UPDATING THEN
    ...
    VALUES (USER, 'UPDATE', CURRENT_TIMESTAMP,
      ...
      'Despuï¿½s: {ID:' || :NEW.ID || ', NOMBRE:"' || :NEW.NOMBRE || '", TIPO:"' || :NEW.TIPO || '", TURNO:"' || :NEW.TURNO || '"}');
  ELSIF DELETING THEN
    INSERT INTO RESTAURANTE.TBL_BITACORA (USUARIO, OPERACION, FECHA, DETALLE)
    VALUES (USER, 'DELETE', CURRENT_TIMESTAMP,
...
BEGIN
  IF UPDATING THEN
    ...
    VALUES (USER, 'UPDATE', CURRENT_TIMESTAMP,
      ...
      'Despuï¿½s: {ID:' || :NEW.ID || ', SALDO_APERTURA:' || :NEW.SALDO_APERTURA || ', SALDO_CIERRE:' || :NEW.SALDO_CIERRE || '}');
  ELSIF DELETING THEN
    INSERT INTO RESTAURANTE.TBL_BITACORA (USUARIO, OPERACION, FECHA, DETALLE)
    VALUES (USER, 'DELETE', CURRENT_TIMESTAMP,
...
BEGIN
  IF UPDATING THEN
    ...
    VALUES (USER, 'UPDATE', CURRENT_TIMESTAMP,
      ...
      'Despuï¿½s: {ID:' || :NEW.ID || ', NOMBRE:"' || :NEW.NOMBRE || '", PRECIO:' || :NEW.PRECIO || '}');
  ELSIF DELETING THEN
    INSERT INTO RESTAURANTE.TBL_BITACORA (USUARIO, OPERACION, FECHA, DETALLE)
    VALUES (USER, 'DELETE', CURRENT_TIMESTAMP,
...
BEGIN
  IF UPDATING THEN
    ...
    VALUES (USER, 'UPDATE', CURRENT_TIMESTAMP,
      ...
      'Despuï¿½s: {ID:' || :NEW.ID || ', TOTAL:' || :NEW.TOTAL || ', METODO_PAGO:"' || :NEW.METODO_PAGO || '"}');
  ELSIF DELETING THEN
    INSERT INTO RESTAURANTE.TBL_BITACORA (USUARIO, OPERACION, FECHA, DETALLE)
    VALUES (USER, 'DELETE', CURRENT_TIMESTAMP,
